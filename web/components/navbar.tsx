      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex gap-8">
            ...
            <Link href="/portfolio" className="text-sm text-foreground/70 hover:text-foreground transition-colors">
              Portfolio
            </Link>
            <Link href="/activity" className="text-sm text-foreground/70 hover:text-foreground transition-colors">
              Activity
            </Link>
